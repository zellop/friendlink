			...
			<div class="card none" id="contentcard">
					...
					<div class='content'>
						<ul class='list-unstyled team-members'>
							...
							<span style='float:left;'><span style='padding:1px;color:#ffffff;background-color:#1CB7FD;'>到期时间：</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='text-success' style='text-align:left;'><span id="duetime2"></span></span></span><br /><br />
							<span id="inimg"></span>
...
function giveValue(inimg){  //图片链接输入图片框
		document.getElementById("inimg").src = inimg;
	}
				...
				echo "<div class='card' id='contentcard'>";
					...
					<div class='content'>
						<ul class='list-unstyled team-members'>
							...
							echo "<span style='float:left;'><span style='padding:1px;color:#ffffff;background-color:#1CB7FD;'>到期时间：</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class='text-success' style='text-align:left;'>".date("Y-m-d", $row['duetime2'])."</span></span><br /><br />";
							echo "<img src='{$row['inimg']}' width ='800px'>";
